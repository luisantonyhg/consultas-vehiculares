...
test('las 19 secciones automáticas habilitadas tienen una fuente oficial verificable', () => {
...
test('las fuentes sensibles apuntan al formulario usado por la consulta', () => {
  ...
  assert.equal(SOURCE_URLS.atu_infracciones, 'https://pasarela.atu.gob.pe/');
